...
const About = () => {
  ...
  const [ref, inView] = useInView({
    threshold: !isMobile ? 0.5 : 0, // Adjust threshold for mobile
  });
      ...
      <div className='container mx-auto'>
        <div className='flex flex-col lg:flex-row items-center'>
          <motion.div
            ...
            className='flex-1 relative mb-8 xl:mb-0'>
            <Image
              src='./about/img2.png' // Make sure the path is correct
              width={559}
              height={721}
              alt='About Hotel'
              priority // Optional: Add priority loading for the image
